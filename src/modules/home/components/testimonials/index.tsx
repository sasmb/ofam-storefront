...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="relative py-32 bg-gradient-to-br from-brand-dark via-green-900/20 to-brand-dark text-white overflow-hidden">
      {/* Enhanced Background Effects */}
      <div className="absolute inset-0">
        {/* Animated gradient mesh */}
        <motion.div 
          className="absolute inset-0 bg-gradient-to-br from-brand-primary/[0.08] via-brand-secondary/[0.05] to-green-600/[0.08]"
          animate={{
        ...
        {/* Moving light orbs */}
        <motion.div
          className="absolute top-1/3 left-1/5 w-72 h-72 bg-brand-primary/15 rounded-full blur-3xl"
          animate={{
            x: [0, 150, 0],
            y: [0, 80, 0],
            scale: [1, 1.2, 1],
        ...
        />
        <motion.div
          className="absolute bottom-1/3 right-1/5 w-80 h-80 bg-brand-secondary/15 rounded-full blur-3xl"
          animate={{
            x: [0, -100, 0],
            y: [0, -60, 0],
            scale: [1, 1.3, 1],
      ...
      >
        ...
        >
          ...
          >
            ...
            <br />
            <motion.span 
              className="bg-clip-text text-transparent bg-gradient-to-r from-brand-primary via-brand-secondary to-green-300"
              animate={{
